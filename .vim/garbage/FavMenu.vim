...
if $LANG=='hu'
  ...
  menutrans &Add\ current\ file		&Aktu?lis\ f?jl\ hozz?ad?sa
  menutrans &Remove			&Elt?vol?t?s
  menutrans &Remove\ current\ file	&Aktu?lis\ f?jl\ elt?vol?t?sa
  menutrans &Edit\ favourites		K&edvencek\ rendez?se
  menutrans Re&fresh			A&ktualiz?l?s
en
